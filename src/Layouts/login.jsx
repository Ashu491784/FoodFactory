...
const Login = () => {
  ...
  return (
    <div className="text-white h-[100vh] flex justify-center items-center bg-cover">
          <div className="fixed inset-0 bg-cover bg-center -z-10" style={{ backgroundImage: "url('../../public/images/1010.jpg')" }}></div>
        ...
        p-8 shadow-lg background-filter backdrop:-blur-sm bg-opacity-30 relative">
           ...
           focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" />
            ...
            bg-white text-blue-700 hover:bg-blue-200 hover:text-white py-2 transition-colors duration-300"><Link to="/">Login</Link></button>
           <div>
